  ...
  AppModule = (function() {
    ...
    */
    ...
    function AppModule(filename, parent) {
      ...
      if (fs.existsSync(this.parent + "/appbotComponent.json")) {
        fileContents = fs.readFileSync(this.parent + "/appbotComponent.json");
        componentInfo = JSON.parse(fileContents);
        this.details = fileContents;
        this.id = "components/" + componentInfo.namespace + "/" + this.id;
      }
    }
